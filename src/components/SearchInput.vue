...
<template>
  <div class="w-full max-w-[520px] mx-auto relative search-container z-[100]">
    <div class="relative flex items-center w-full">
      ...
      <button v-if="query"
        class="absolute right-[48px] bg-transparent border-none text-gray-400 cursor-pointer p-1 flex items-center justify-center hover:text-gray-900 transition-colors"
