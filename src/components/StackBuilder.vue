      ...
      >
        <template #actions>
          ...
          <div v-if="!renaming" id="ow" class="relative shrink-0">
            ...
            <div v-if="showOverflow" class="absolute right-0 top-full mt-1 z-50 bg-white border border-brand-forest/10 shadow-sm min-w-[180px] rounded-2xl">
              <button type="button" @click="startRename" class="flex items-center gap-3 w-full text-left px-4 h-12 text-sm font-bold text-brand-forest hover:bg-brand-bg border-b border-brand-forest/10 cursor-pointer bg-transparent">
              ...
              <button type="button" @click="showDeleteConfirm = true; showOverflow = false" class="flex items-center gap-3 w-full text-left px-4 h-12 text-sm font-bold text-red-600 hover:bg-red-50 cursor-pointer bg-transparent">
