...
<template>
    ...
    >
        ...
        <div class="flex flex-col md:flex-row gap-0 md:gap-6">
            <div
                class="flex md:flex-col border border-gray-200 md:w-56 lg:w-64 shrink-0 md:self-start"
                role="tablist"
            ...
            >
                <button
                    ...
                    class="flex items-center gap-3 px-4 py-3.5 text-left border-b md:border-b-0 md:border-r border-gray-200 last:border-b-0 transition-colors w-full"
                    :class="activeTab === index ? 'bg-gray-900 text-white border-gray-900' : 'bg-white text-gray-900 hover:bg-gray-50'"
            ...
            <div
                ...
                class="border border-gray-200 p-5 md:p-6 bg-white flex-1"
            ...
            >
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-5 pt-4 border-t border-gray-200">
                    <a
                        v-for="tool in featuredTools[index]"
                        :key="tool.slug"
                        :href="`/tools/${tool.slug}`"
                        class="border border-gray-200 p-3 hover:border-gray-900 transition-colors no-underline block group"
                    >
