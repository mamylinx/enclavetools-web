...
/** Brain / AI / intelligence SVG icon component. */
...
/** Database / storage SVG icon component. */
...
/** Bot / automation SVG icon component. */
...
/** Message / chat bubble SVG icon component. */
...
/** File / document text SVG icon component. */
...
/** Volume / speaker SVG icon component. */
...
/** Image / picture SVG icon component. */
...
/** Graduation cap / education SVG icon component. */
...
/** Activity / pulse / analytics SVG icon component. */
...
/** Shield / security SVG icon component. */
...
/** Layers / stack SVG icon component. */
...
/** Server / infrastructure SVG icon component. */
...
/** Git branch / version control SVG icon component. */
...
/** Terminal / command-line SVG icon component. */
export const Terminal = icon([
  s('path', { d: 'M12 19h8' }),
  s('path', { d: 'm4 17 6-6-6-6' }),
])

/** Chart bar / statistics SVG icon component. */
...
/** Circle SVG icon component. */
export const Circle = icon([
  s('circle', { cx: '12', cy: '12', r: '10' }),
])

/** Maps icon names to their Vue component definitions for dynamic lookup. */
